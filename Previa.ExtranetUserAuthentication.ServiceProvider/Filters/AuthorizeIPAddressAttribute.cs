...
namespace Previa.ExtranetUserAuthentication.ServiceProvider.Filters
{
    public class AuthorizeIPAddressAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (!IsIpAddressValid(ipAddress))
            {
                ...
                log4net.LogManager.GetLogger("IPFILTER").Error("Filter denied ipadress: " + ipAddress);
        ...
        public static bool IsIpAddressValid(string ipAddress)
        {
            ...
            {
                log4net.LogManager.GetLogger("IPFILTER").Error("IP Filter denied since blank or missing IP");
                return false;
            }
            ...
            string addresses =
              Convert.ToString(ConfigurationManager.AppSettings["LocalUserAllowedIPAddresses"]);
